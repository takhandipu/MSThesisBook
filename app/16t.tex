...
\begin{figure*}[!htbp]
    ...
    \begin{subfigure}[t]{0.625\textwidth}
        \includegraphics[width=\textwidth]{alltopology/16Throughput24d1}
    ...
    ~\\
    \begin{subfigure}[t]{0.625\textwidth}
        \includegraphics[width=\textwidth]{alltopology/16Throughput24d16}
    ...
    \end{subfigure}
    \caption{Average network throughput with varying number of radios for various application data rates on a network topology with 16 secondary users}
\end{figure*}
\end{landscape}
