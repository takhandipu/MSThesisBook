\begin{center}
    ...
    \draw [line width=0.25mm,->] (su1) to (channel1);
    \draw [line width=0.25mm,->] (su1) to (channel2);
    \draw [line width=0.25mm,->] (su1) to (channel3);
    \draw [line width=0.25mm,->] (su1) to (channel4);
    \draw [line width=0.25mm,->] (su2) to (channel1);
    ...
    \node[draw=white, thick, label=below:{\tiny Thoughput$=?$}] (calculateThroughput) [left=of su2, xshift=-1.5mm, yshift=5mm]{
        \begin{tikzpicture} [scale=0.5]
        \draw [line width=0.25mm,green!50!black] (0.5,0.44) circle(1);%fill=green!50!black
        \end{tikzpicture}
    };
    
    \draw [line width=0.25mm,->] (calculateThroughput) to (su1);
    \draw [line width=0.25mm,->] (calculateThroughput) to (su2);
