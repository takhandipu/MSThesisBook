\begin{center}
    ...
    \node[draw=black, thick, label=below:\tiny Channel 5, minimum width=25mm] (channel5) [below=of channel4, yshift=-5mm] {
    };
...
\end{center}
\begin{center}
    Enables heterogeneous wireless access~\cite{song2012performance}\\
    %It happens as different radio can operate over different channels.
\end{center}
